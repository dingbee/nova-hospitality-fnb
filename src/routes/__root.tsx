...
const queryClient = new QueryClient({ defaultOptions: { queries: { staleTime: 60 * 1000, refetchOnWindowFocus: false } } });
export const Route = createRootRoute({
  head: () => ({ meta: [
    ...
    { name: "robots", content: "noindex,nofollow" }, { name: "theme-color", content: "#101418" },
  ], links: [{ rel: "stylesheet", href: appCss }, { rel: "stylesheet", href: shellCss }, { rel: "manifest", href: "/nova-terminal.webmanifest" }] }),
...
function RootComponent() { return <html lang="en" data-os-theme="dark"><head><HeadContent /></head><body><QueryClientProvider client={queryClient}><Outlet /><Toaster /></QueryClientProvider><Scripts /></body></html>; }
