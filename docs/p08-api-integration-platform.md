...
| any `*:write` scope | `api_service` (new, P08) | **exactly** `sales.manage` — see `standalone/db/migrations/0057_p08_api_service_role.sql` and `permissions.ts`'s own comment on the grant |
